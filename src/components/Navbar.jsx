...
//   return (
//     <nav className="sticky top-0 z-50 h-16 flex justify-between items-center px-10 bg-white/90 backdrop-blur-md shadow-sm border-b border-brand-primary-300/5 font-sans">
...
//         {/* --- LINKS NAVIGASI UTAMA --- */}
//         <div className="hidden md:flex gap-1 items-center">
//           <NavLink
//             to="/"
//             className={({ isActive }) =>
//               `px-4 py-1.5 rounded-lg text-[13px] font-bold transition-all ${isActive ? "bg-brand-primary-300 text-neutral-default shadow-sm" : "text-brand-primary-300 hover:bg-brand-primary-100/20"}`
//             }
//           >
//             Beranda
//           </NavLink>

//           {/* DROPDOWN KUSTOM: ENSIKLOPEDIA (Mengarah ke Artikel & Kandungan Bahan) */}
//           <div className="relative group">
//             <NavLink
//               to="/ensiklopedia"
//               className={({ isActive }) =>
//                 `px-4 py-1.5 rounded-lg text-[13px] font-bold transition-all flex items-center gap-1 ${isActive ? "bg-brand-primary-300 text-neutral-default shadow-sm" : "text-brand-primary-300 hover:bg-brand-primary-100/20"}`
//               }
//             >
//               Ensiklopedia{" "}
...
//       {/* --- PANEL USERS & NOTIFIKASI RIGHT SIDE --- */}
...
//                 <div className="w-10 h-10 bg-brand-primary-300 rounded-full flex items-center justify-center text-neutral-default text-sm font-medium border-2 border-neutral-default shadow-md transition-transform group-hover:scale-105">
...
//                       <Link
//                         to="/admin/dashboard"
//                         className="w-full text-left px-4 py-2.5 text-[11px] font-bold text-feedback-warning-300 bg-brand-dark-400 hover:bg-brand-dark-500 rounded-xl transition-colors uppercase tracking-wider flex items-center gap-2 mb-1"
//                       >
...
//                     <Link
//                       to="/profil"
//                       className="w-full text-left px-4 py-2 text-[11px] font-bold text-neutral-600 hover:bg-neutral-50 rounded-xl uppercase flex items-center gap-2"
//                     >
//                       <User className="w-3.5 h-3.5 text-brand-primary-300" />{" "}
//                       Akun Saya
//                     </Link>
    ...
    <nav className="sticky top-0 z-50 h-16 flex justify-between items-center px-10 bg-white/90 backdrop-blur-md shadow-sm border-b border-brand-primary-300/5 font-sans">
      <div className="flex items-center gap-12">
        ...
        <div className="hidden md:flex gap-1 items-center">
          ...
          {/* DROPDOWN KUSTOM BARU: DAUR ULANG (Membawa user ke 3 halaman) */}
          <div className="relative group">
            <NavLink
              to="/daur-ulang"
              className={({ isActive }) =>
