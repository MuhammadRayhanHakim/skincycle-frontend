...
const AdminOrderManagement = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      // ✅ FIX: Tambah SweetAlert agar admin tahu fetch gagal, bukan diam saja
      Swal.fire({
        title: "Koneksi Gagal",
        text: "Tidak dapat memuat data pesanan. Pastikan server backend aktif.",
        icon: "error",
    ...
    try {
      ...
      if (result.status === "success") {
        ...
        Swal.fire({
          ...
          text: `🎯 Berhasil memperbarui Order #TRX-0${selectedOrder.id_riwayat} menjadi ${tempStatus}!`,
          icon: "success",
          confirmButtonColor: "#3D5532",
        ...
        Swal.fire({
          title: "Gagal Update",
          text: result.message || "Gagal mengubah status pelacakan kurir.",
          icon: "error",
          confirmButtonColor: "#3D5532",
        });
      }
      ...
      Swal.fire({
        ...
        text: "Terjadi kesalahan sistem, gagal terhubung ke server backend.",
        icon: "error",
        confirmButtonColor: "#3D5532",
      });
    }
  ...
  const filteredOrders = orders.filter((order) => {
    const matchSearch = order.aktivitas
      ? order.aktivitas.toLowerCase().includes(searchTerm.toLowerCase())
      : false;
    const matchStatus =
            ...
            <table className="w-full text-left border-collapse min-w-[1200px]">
              <thead className="bg-neutral-50 text-[11px] text-neutral-400 font-bold uppercase border-b border-neutral-100">
                <tr>
                  ...
                  <th className="px-6 py-5 w-[30%]">Kontak &amp; Alamat Tujuan</th>
                  ...
                  <th className="px-6 py-5 text-center w-[10%]">Aksi Operasional</th>
                </tr>
              </thead>
              <tbody className="text-xs font-semibold text-neutral-600 divide-y divide-neutral-50">
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan="7" className="text-center py-12 text-neutral-400 italic">
                      Belum ada aktivitas transaksi belanja yang tercatat.
                    </td>
                  </tr>
                ) : (
                  filteredOrders.map((order) => {
                    const part = order.aktivitas ? order.aktivitas.split(" | ") : [];
                    ...
                    return (
                      ...
                      >
                          ...
                          <div className="max-w-[320px]">
                            ...
                            <span className="text-[9px] font-mono text-neutral-400 mt-1 block">
                              ...
                              <b className="text-brand-dark-500 uppercase">
                                {order.rincian_pengiriman?.jenis_pembelian || "saldo"}
                              </b>
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 font-sans font-black text-feedback-error-200 text-sm whitespace-nowrap">
                          -Rp{" "}
                          {Math.abs(parseInt(order.jumlah_saldo)).toLocaleString("id-ID")}
                        </td>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  ...
                  />
                  <span className="text-[10px] tracking-tight leading-tight">Diproses</span>
                </div>
                ...
                >
                  ...
                  />
                  <span className="text-[10px] tracking-tight leading-tight">Dikirim</span>
                </div>
                ...
                >
                  ...
                  />
                  <span className="text-[10px] tracking-tight leading-tight">Selesai</span>
                </div>
              </div>
